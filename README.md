...
**Status:** working educational baselines, created with OpenAI Codex assistance
in September 2026. Code and experiments were implemented and executed with AI
assistance. This repository is not employment experience, production deployment,
an independent research paper, or an OpenAI affiliation. Its owner still needs
to explain, reproduce and extend the work independently.
...
The 76 AI-authored queries are synthetic fixtures: 26 dev and 50 test. The test
...
|---|---:|---:|---:|---:|---:|---:|
| Token overlap | 0.800 | 0.975 | 0.871 | 0.760 | 0.789 | 0.800 |
| BM25 | 0.850 | 0.950 | 0.896 | 0.820 | 0.805 | 0.600 |
...
- Pet facts are paraphrased from the owner's
  [README at the pinned commit](https://github.com/fanqiye/caigou-desktop-pet/blob/048742b363227b2ae768822f0f79bf06cf673163/README.md).
...
See [LEARNING.md](LEARNING.md) for a Chinese walkthrough and independent-work
milestones. Repository ownership and generated code alone do not prove mastery.
